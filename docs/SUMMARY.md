...
- [Tutorials]()
  ...
  - [How to add a new trainer class]()
    - [How to add new trainer front pic](tutorials/how_to_trainer_front_pic.md)
    - [How to add new trainer back pic](tutorials/how_to_trainer_back_pic.md)
  ...
  - [Vs. Seeker](tutorials/how_to_vs_seeker.md)
  ...
  - [How to use Dynamic Shop](tutorials/how_to_dynmultichoice.md)
