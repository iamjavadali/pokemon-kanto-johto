...
#define FLAG_GOT_TRAINER_WATCH                                      0x493 // Yellow opening: Mom gives the Trainer Watch
#define FLAG_TRAINER_WATCH_TIME_VALID                               0x494 // Saved fallback/manual clock contains valid time
