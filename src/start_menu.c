...
static bool8 StartMenuWatchCallback(void);
...
static const u8 sText_MenuWatch[] = _("WATCH");
...
static const struct MenuAction sStartMenuItems[] =
{
    ...
    [MENU_ACTION_WATCH]           = {sText_MenuWatch,    {.u8_void = StartMenuWatchCallback}},
};
...
static void BuildNormalStartMenu(void)
{
    ...
    if (FlagGet(FLAG_GOT_TRAINER_WATCH) == TRUE)
        AddStartMenuAction(MENU_ACTION_WATCH);
